		...
		<nav class = "navbar navbar-inverse navbar-fixed-top" style="background-color: green; color: white;" >
			<div class = "container-fluid">
				<div class = "navbar-header" >
					<img src = "images/GLA-University-logo.jpg" width = "50px" height = "50px"/>
					...
					<div class = "panel panel-primary">
						...
						<div class = "panel-body">
							<form enctype = "multipart/form-data">
								...
								<button type = "button" class = "btn btn-success btn-block" id = "Student_login"><span class = "glyphicon glyphicon-save"></span> Student Login</button>
							</form>
						</div>
					</div>
				</div>
